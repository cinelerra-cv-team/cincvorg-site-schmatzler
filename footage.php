...
<li> <a href="http://cinelerra.org/examples/NY_titler_timefront.ogg">swiping-transparent title</a>, a modified version of the above title, made adding also the Timefront effect.</li>
</ul>
