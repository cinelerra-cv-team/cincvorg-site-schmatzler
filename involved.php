...
<div class="content">
 <h1 id="page-heading">Getting Involved</h1>
...
<p>	1. for occasional surfers / users of Cinelerra,  <br>
	(to subscribe at the list only for a feedback about a
	typo on Cinelerra is not the best approach)  <br>
	you may send a mail to tv-list at gmail.com for that kind of help <br>
 </p>

  <p> 	2. for those who like to participate stable to the community of
	cinelerra, subscribe to this list <br>
	 (be aware that non technical people and programmers are on the same list, in which they
	discuss of C++ code)<br>
</p>

<p>	3. for test/report/software patch/suggestions. Explain how to
	contribute to this steps, what to send to this list, what software
	use for better debug helping, and so on
Please re-write this in a helpful way.
</p>


4. for gitter ;) clone Cinelerra code on Git

5. for video editor give to works made with  Cinelerra visibility
on internet (vimeo/youtube)


6. for donors make (and how to do) A Bounty! :)
...
We use the IRC network <a href="http://freenode.net/">Freenode</a>. If you don't know which server to connect to, try <code>irc.freenode.net</code>, port 6667 
   ...
   The channel is logged into a <a href="http://irclog.cinelerra-cv.org/">web archive</a>.
   </p>
...
<address>Last modified on March 31 2014</address>
